...
const BulletListSchema = z.object({
  ...
  items: z.array(BulletPointSchema).describe('Lista de pontos com marcadores'),
});
...
export const SlideSchema = z.object({
  ...
  content: z.array(ContentBlockSchema).describe('Blocos de conteúdo do slide'),
  speakerNotes: z
    .string()
    .optional()
    .describe('Notas do apresentador para este slide'),
  duration: z.number().optional().describe('Duração estimada em segundos'),
});
